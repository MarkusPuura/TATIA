...
print(f"Top 5 hashtag used by Republicans: {democrat_words}")
...
print(f"Top 5 hashtag used by Democrats: {republican_words}")

# Afficher les coefficients associés à ces mots
print("Coefficients for Republican hashtag:", classifier.coef_[0, democrat_indices])
print("Coefficients for Democrats hashtag:", classifier.coef_[0, republican_indices])